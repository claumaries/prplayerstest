            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                    <div class="flex lg:justify-center lg:col-start-2">
                       <img :src="$page.props.logoUrl" alt="logo" />
                    </div>
                    <nav class="-mx-3 flex flex-1 justify-end">
                        ...
                        <template v-else>
                            <Link
                                :href="route('login')"
                                class="rounded-md px-4 py-2 mr-2 bg-blue-500 text-white font-semibold ring-1 ring-transparent transition hover:bg-blue-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 dark:bg-blue-700 dark:hover:bg-blue-800 dark:focus-visible:ring-blue-300"
                            >
                                Log in
                            </Link>
                            ...
                            <Link
                                :href="route('register')"
                                class="rounded-md px-4 py-2 bg-green-500 text-white font-semibold ring-1 ring-transparent transition hover:bg-green-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500 dark:bg-green-700 dark:hover:bg-green-800 dark:focus-visible:ring-green-300"
                            >
                                Register
                            </Link>
                        </template>
                    ...
                    <section class="bg-white dark:bg-gray-900">
                        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                            <div class="max-w-screen-md mb-8 lg:mb-16">
                                ...
                                <p class="text-gray-500 sm:text-xl dark:text-gray-400">Here at Demo we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
                            </div>
