...
const previewImage = ref(props.user?.avatar ?? '')
...
const breadcrumbs = [
    ...
    {name: 'Update user', routeName: null},
]
</script>
                    ...
                    <div class="col-span-12 lg:col-span-7 bg-gray-50 border-2 border-gray-100 rounded-md">
                        <div class="p-5">
                            <div class="p-3">
                                ...
                                <div class="mt-5">
                                    <select class="mt-1 bloc w-full sm:w-1/4" v-model="form.prefixname" required autofocus>
